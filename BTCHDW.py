...
while True:
    ...
    btcaddr2 = hdwallet.p2wpkh_address()
    btcaddr3 = hdwallet.p2wpkh_in_p2sh_address()
    btcaddr4 = hdwallet.p2wsh_in_p2sh_address()
    # =========================[M M D Z A . C o M]==============================
    page4 = requests.get('https://bitcoin.atomicwallet.io/address/' + btcaddr4)
    tree4 = html.fromstring(page4.content)
    value4 = tree4.xpath('//small[@class="text-muted"]/text()')
    # =========================[M M D Z A . C o M]==============================
    page3 = requests.get('https://bitcoin.atomicwallet.io/address/' + btcaddr3)
    tree3 = html.fromstring(page3.content)
    value3 = tree3.xpath('//small[@class="text-muted"]/text()')
    # =========================[M M D Z A . C o M]==============================
    page2 = requests.get('https://bitcoin.atomicwallet.io/address/' + btcaddr2)
    tree2 = html.fromstring(page2.content)
    value2 = tree2.xpath('//small[@class="text-muted"]/text()')
    # =========================[M M D Z A . C o M]==============================
    page1 = requests.get('https://bitcoin.atomicwallet.io/address/' + btcaddr1)
    tree1 = html.fromstring(page1.content)
    value1 = tree1.xpath('//small[@class="text-muted"]/text()')
    # =========================[M M D Z A . C o M]==============================
    promptPUB = '''
    ...
    print(red, '===========================[Scan No.', str(z), ']=====================================', reset)
    print(green, '| BTC Address (P2SH):', str(btcaddr1))
    print(green, '| BTC Address (BECH32):', str(btcaddr2))
    print(white, '| BTC Address (P2WPKH):', str(btcaddr3))
    print(white, '| BTC Address (P2WSH):', str(btcaddr4))
    print(red, '| BTC Private Key :', str(privatekey))
    print(red, '====================================[ M M D R Z A . C o M ]==========================================')
    print(yellow, 'P2SH',white,str(value1), yellow,'BECH32',white,str(value2),yellow,'P2WPKH',white,str(value3),yellow,'P2WSH',white,str(value4))
    print(red, '====================================[ M M D R Z A . C o M ]==========================================', reset)
    z += 1
